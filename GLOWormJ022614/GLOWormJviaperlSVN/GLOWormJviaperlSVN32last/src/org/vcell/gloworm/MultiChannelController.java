	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.contains(saveLabel)){
			...
			try {
				...
				out.println("StretchToFit = " + (deNovoMovieFile!=null?false:(stack instanceof MultiQTVirtualStack?((MultiQTVirtualStack) stack).getIsStretchToFit():(imp.getRemoteMQTVSHandler()!=null?imp.getRemoteMQTVSHandler().isStretchToFitOverlay():false) ) ) );
				out.println("ViewInOverlay = " + (deNovoMovieFile!=null?false:(stack instanceof MultiQTVirtualStack?((MultiQTVirtualStack) stack).getIsViewInOverlay():(imp.getRemoteMQTVSHandler()!=null?imp.getRemoteMQTVSHandler().isViewOverlay():false) ) ) );

		...
		while (true) {
			...
			if (doDecon) {
				...
				IJ.runMacro(""
						...
						"		    File.close(f);	    \n" + 
						"");
			    new MacroRunner("exec(\"cmd\", \"/c\", \""+dir+"GenerateFusion.bat\")");
			}		
		}
	}
}

...
//		 ImageStack stack2 = null;
		 ...
		 if (outputSlices > 1) {
			 File saveDir = new File (IJ.getDirectory("temp")+"Documents"+File.separator+imp.getTitle()+ new GregorianCalendar().getTimeInMillis() +"_resliced");
			 // WITHOUT THE TIMESTAMP IN FILEPATH, THE OLD VERSION WOULD REUSE OLD TMP_RESLICE FOLDER, BAD NEWS.  WAS AN UNCLEVER WAY OF DOING RESLICE OF VOLUMES TOO SMALL TO FIT IN MEMORY, RESUMING AFTER CRASH.
